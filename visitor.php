<?php 
  ...
  $dob=(mysqli_query($link, "SELECT DOB FROM visitor where VISITOR_ID='".$_SESSION["id"]."' ") ->fetch_array()[0] );
  $locality=(mysqli_query($link, "SELECT LOCALITY FROM visitor where VISITOR_ID='".$_SESSION["id"]."' ") ->fetch_array()[0] );
  $phone=(mysqli_query($link, "SELECT phone_number FROM phone_number where USER_ID='".$_SESSION["id"]."' ") ->fetch_array()[0] );
...
<body>
  ...
  <section class="home-section">
      ...
      <div class="sales-boxes">
        <div class="recent-sales box">
          ...
          <table style="font-family: Arial, Helvetica, sans-serif; border-collapse: collapse; width: 100%;">
              ...
              <?php 
                      $query = "SELECT * FROM users, samples_collected where User_Id=Visitor_Id and Visitor_Id = '".$_SESSION['id']."' ";
          ...
          <table style="font-family: Arial, Helvetica, sans-serif; border-collapse: collapse; width: 100%;">
              ...
              <?php 
                      $query1 = " select * from patients, users where user_id=Patient_Id and Patient_Id = '".$_SESSION['id']."' ";
    ...
    <input id="name" type="date" placeholder="Enter DOB" name="dob" max="2004-01-01" value="<?php echo htmlspecialchars($dob); ?>" required><br>
    
    <label for="places"><b>Locality</b> </label><br>
    <input type="text" placeholder="Enter Locality" name="locality" value="<?php echo htmlspecialchars($locality); ?>" required><br>

    <label for="phone">Phone Number</label><br>
    <input type="number" id="phone" name="phone" value="<?php echo htmlspecialchars($phone); ?>" min="0000000000" max="9999999999"><br>

    <label for="gender"><b>Gender</b></label><br>
    <input type="text" placeholder="Enter Gender" disabled="disabled" name="gender" value="<?php echo htmlspecialchars($_SESSION["gender"]); ?>" required><br>
