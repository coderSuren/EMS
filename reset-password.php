...
<head>
    ...
    <style>
        ...
        .wrapper{ margin:10% 30% 20%; padding: 25px; border: 4px solid black; border-radius: 5px; background-color: white;}
    </style>
</head>
<body>
    <div class="wrapper">
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post"> 
            ...
            <div class="form-group">
                ...
                <a class="btn btn-link ml-2" onclick="history.back(-3)">Cancel</a>
            </div>
        </form>
    </div>    
</body>
